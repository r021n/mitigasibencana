  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 text-left">
      ...
      <div className="flex justify-end">
        <Link
          to="#"
          className="font-caption text-caption text-primary hover:underline font-semibold"
        >
          Lupa password?
        </Link>
      </div>
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full block font-label-md text-label-md bg-primary text-on-primary rounded-full py-4 shadow-[0_6px_16px_rgba(0,74,198,0.25),inset_2px_2px_4px_rgba(255,255,255,0.3)] active:scale-95 active:translate-y-0.5 active:shadow-none font-bold text-center cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
      >
